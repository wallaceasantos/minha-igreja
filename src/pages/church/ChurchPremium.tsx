  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {liveStreams.length > 0 && (
        <section className="py-16 bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-red-100 text-red-700 px-4 py-2 rounded-full text-sm font-medium mb-4 animate-pulse dark:bg-red-900 dark:text-red-300">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400">
                Assista aos cultos e eventos da igreja
              </p>
            </div>

            <div className="max-w-4xl mx-auto">
              {liveStreams.map((stream) => (
                <Card key={stream.id} className="border-2 border-red-200 shadow-2xl overflow-hidden dark:border-red-800 dark:bg-gray-800">
                  <div className="aspect-video bg-gray-900 relative">
                    {/* Player da Plataforma Principal */}
                    {stream.primary_platform === 'youtube' && stream.youtube_video_id && (
                      <iframe
                    ...
                    {stream.primary_platform === 'facebook' && stream.facebook_url && (
                      <div className="w-full h-full flex items-center justify-center">
                        ...
                        >
                          ...
                          <p className="text-lg font-semibold">Assistir no Facebook</p>
                          <p className="text-sm text-gray-400 mt-2">Clique para abrir em nova aba</p>
                        </a>
                      </div>
                    )}
                    {stream.primary_platform === 'instagram' && stream.instagram_url && (
                      <div className="w-full h-full flex items-center justify-center">
                        <a
                        ...
                        >
                          ...
                          <p className="text-lg font-semibold">Assistir no Instagram</p>
                          <p className="text-sm text-gray-400 mt-2">Clique para abrir em nova aba</p>
                        </a>
                      </div>
                    )}
                    {stream.primary_platform === 'twitch' && stream.twitch_url && (
                      <div className="w-full h-full flex items-center justify-center">
                        <a
                          ...
                          className="text-white text-center"
                        >
                          <svg className="w-16 h-16 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24"><path d="M11.571 4.714h1.715v5.143H11.57zm4.715 0H18v5.143h-1.714zM6 0L1.714 4.286v15.428h5.143V24l4.286-4.286h3.428L22.286 12V0zm14.571 11.143l-3.428 3.428h-3.429l-3 3v-3H6.857V1.714h13.714Z"/></svg>
                          <p className="text-lg font-semibold">Assistir na Twitch</p>
                          <p className="text-sm text-gray-400 mt-2">Clique para abrir em nova aba</p>
                        </a>
                      </div>
                    )}
                  ...
                  <CardContent className="p-6">
                    ...
                    {(stream.facebook_url || stream.instagram_url || stream.twitch_url) && (
                      <div className="flex flex-wrap gap-3">
                        <span className="text-sm font-medium text-gray-600">Assistir também em:</span>
                        {stream.facebook_url && (
                          <a
                            href={stream.facebook_url}
                            target="_blank"
