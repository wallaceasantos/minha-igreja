...
export default function BirthdayCard({ members }: BirthdayCardProps) {
  ...
  // Cores do gradiente baseadas na quantidade
  const weekGradientClass = weekBirthdays.length === 1
    ...
    : weekBirthdays.length <= 3
      ? 'from-orange-50 via-pink-50 to-purple-50 border-orange-200'
      : 'from-blue-50 via-purple-50 to-pink-50 border-blue-200';

  const monthGradientClass = monthBirthdays.length === 1
    ? 'from-pink-50 via-purple-50 to-blue-50 border-pink-200'
  ...
  return (
    <>
            ...
            <div className="flex items-center justify-between">
              <CardTitle className="flex items-center gap-3 text-xl">
                <div className="flex items-center gap-2">
                  <Clock className="w-7 h-7 text-orange-600 animate-pulse" />
                  <span className="bg-gradient-to-r from-orange-600 via-pink-600 to-purple-600 bg-clip-text text-transparent font-bold">
                    🎉 Aniversariantes da Semana
                  </span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-bold text-lg text-gray-800 group-hover:text-pink-600 transition-colors">
                    ...
                    <Button
                      ...
                      className="bg-gradient-to-r from-green-500 to-emerald-500 text-white border-0 hover:from-green-600 hover:to-emerald-600 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
                    >
        ...
        <Card className={`border-2 ${monthGradientClass} shadow-lg mb-8 animate-in fade-in duration-500`}>
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <CardTitle className="flex items-center gap-3 text-xl">
                <div className="flex items-center gap-2">
                  <Cake className="w-7 h-7 text-pink-600 animate-pulse" />
      ...
      {weekBirthdays.length === 0 && monthBirthdays.length === 0 && (
        <Card className="border-2 border-dashed border-gray-200 bg-gray-50 mb-8">
          <CardContent className="py-8">
            <div className="text-center">
              <Cake className="w-12 h-12 mx-auto mb-3 text-gray-400" />
              <p className="text-gray-600 font-medium">Nenhum aniversariante nesta semana ou neste mês</p>
